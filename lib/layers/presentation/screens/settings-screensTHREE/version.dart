...
class THREEVersionClass extends StatefulWidget {
  @override
  THREEVersionClassState createState() => THREEVersionClassState();
}

class THREEVersionClassState extends State<THREEVersionClass> {
  String _version = '';
